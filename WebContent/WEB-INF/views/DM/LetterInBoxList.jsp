...
<%
	List<Dm> bList = (List<Dm>)request.getAttribute("bList");
                        ...
                        <div class="row" style="margin-bottom: 6%;">
                            ...
                            <div class="col-lg-12">
                                <div class="inbox-top" style="    width: 100%;height: 50px; border: 1px solid #F5F6FA;background: #F5F6FA;margin-bottom: 15px;padding-left: 35px;padding-right: 15px;color: #353535;font-size: 16px;position: relative;line-height: 48px;">
                                    <div class="inbox" style="    text-align: left;position: relative;left: 10px;">보낸 사람</div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="inbox-top2">
                                    <div class="inbox" style="    text-align: left;position: relative;left: 10px;"><%= nOne.getUserId() %></div>
                                    <div class="inbox"><a href="/letter/detail?letterNo=<%= nOne.getLetterNo() %>"><%= nOne.getLetterContents() %></a><div class=""></div></div>
